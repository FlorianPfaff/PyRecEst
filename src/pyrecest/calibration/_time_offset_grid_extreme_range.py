...
from ._time_offset_metric_stability import (
    install_time_offset_metric_stability_contract,
)
...
def install_time_offset_grid_extreme_range_contract() -> None:
    """Install overflow-safe handling for grids and calibration metrics."""
