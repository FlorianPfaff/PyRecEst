...
_FILTER_EXPORTS: Final[dict[str, str]] = {
    ...
    "CheapJointProbabilisticDataAssociationFilter": ".cheap_joint_probabilistic_data_association_filter",
    "CheapJPDAF": ".cheap_joint_probabilistic_data_association_filter",
    "CJPDAF": ".cheap_joint_probabilistic_data_association_filter",
