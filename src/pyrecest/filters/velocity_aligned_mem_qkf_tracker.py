...
class VelocityAlignedMEMQKFTracker(MEMQKFTracker):
    """MEM-QKF whose moving-mode orientation is aligned with kinematic velocity.
    ...
    speed_threshold : float, default=1e-9
        Minimum speed required before the heading alignment is applied.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._align_orientation_with_velocity_if_moving()
    ...
    def predict_linear(
        ...
        """Predict one step and realign the orientation whenever moving."""
    ...
    def update(
        ...
        """Update and use heading-aligned orientation for moving targets."""
        self._align_orientation_with_velocity_if_moving()
        super().update(
            measurements,
            meas_mat=meas_mat,
    ...
    def _update_single_measurement_qkf(
        ...
        if not self._align_orientation_with_velocity_if_moving():
