...
| `CJPDAF`                                       | `pyrecest.filters`                  | experimental     | `CJPDAF`                                       | Fitzgerald-style cheap JPDA with complementary missed-detection mass; NumPy only.                                    |
| `CheapJPDAF`                                   | `pyrecest.filters`                  | experimental     | `CheapJPDAF`                                   | Fitzgerald-style cheap JPDA with complementary missed-detection mass; NumPy only.                                    |
| `CheapJointProbabilisticDataAssociationFilter` | `pyrecest.filters`                  | experimental     | `CheapJointProbabilisticDataAssociationFilter` | Fitzgerald-style cheap JPDA with complementary missed-detection mass; NumPy only.                                    |
